...
-- Settlement reconciliation columns (Phase 3 v2, 2026-05-02). Idempotent — re-run safe.
-- ON THE LIVE DB these columns + index already exist from the v1 attempt; the
-- IF NOT EXISTS clauses will no-op cleanly. Re-applying schema.sql post-deploy
-- is unnecessary but safe.
